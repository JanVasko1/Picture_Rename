...
def Get_All_Templates_List(Settings: dict, window: CTk|None) -> list:
    ...
    Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=["0", "General", "Template", "Templates_List"], Information=Files_Templates, User_Change=False)

    return Files_Templates

# --------------------------------------------- Global Settings update --------------------------------------------- #
def Save_Value(Settings: dict|None, Configuration: dict|None|None, window: CTk|None, Variable: StringVar|IntVar|BooleanVar|None, File_Name: str, JSON_path: list, Information: bool|int|str|list|dict, User_Change: bool|None = True) -> None:
...
def Import_Data(Settings: dict, Configuration: dict|None, window: CTk|None, import_file_path: str, Import_Type: str,  JSON_path: list, Method: str, User_Change: bool) -> None:
    ...
    if Can_Import == True:
        ...
        Save_Value(Settings=Settings, Configuration=None, window=window, Variable=None, File_Name="Settings", JSON_path=JSON_path, Information=Upload_updated_data, User_Change=User_Change)
