...
def Page_Rename(Settings: dict, Configuration: dict, window: CTk, Frame: CTkFrame):
    ...
    Frame_RENAME_Column_A.pack_propagate(flag=False)
    ...
    # Widgets
    Rename_Widget = W_All_pages.Rename_new(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_RENAME_Column_A, Progress_Bar=Progress_Bar, GUI_Level_ID=2)
    Rename_Widget.Show()   