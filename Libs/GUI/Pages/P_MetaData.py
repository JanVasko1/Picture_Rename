...
def Page_Metadata(Settings: dict, Configuration: dict, window: CTk, Frame: CTkFrame):
    ...
    Frame_META_Column_A.pack_propagate(flag=False)
    ...
    # Widgets
    Metadata_Widget = W_All_pages.Metadata_new(Settings=Settings, Configuration=Configuration, window=window, Frame=Frame_META_Column_A, Progress_Bar=Progress_Bar, GUI_Level_ID=2)
