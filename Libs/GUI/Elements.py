...
def Define_Accent_Color(Color_json: list|str) -> tuple|str|None:
...
def Define_Hover_Color(Color_json: list|str, Accent_Color: tuple|str) -> tuple|str|None:
...
def Get_Button(Frame: CTk|CTkFrame, Button_Size: str) -> CTkButton:
    ...
    fg_color = Define_Accent_Color(Color_json=Configuration_Button_Normal["fg_color"])
    hover_color = Define_Hover_Color(Color_json=Configuration_Button_Normal["hover_color"], Accent_Color=fg_color)
...
def Get_Button_Icon(Frame: CTk|CTkFrame, Icon_Set: str, Icon_Name: str, Icon_Size: str, Button_Size: str) -> CTkFrame:
    ...
    if Button_Size == "Picture_SideBar":
        Accent_Color_help = Define_Accent_Color(Color_json=Configuration_Button_Icon["Accent_Color_help"])
    else:
        Accent_Color_help = Define_Accent_Color(Color_json=Configuration_Button_Icon["fg_color"])
    hover_color = Define_Hover_Color(Color_json=Configuration_Button_Icon["hover_color"], Accent_Color=Accent_Color_help)
...
def Get_RadioButton_Normal(Frame: CTk|CTkFrame, Var_Value: int|str) -> CTkRadioButton:
    ...
    hover_color = Define_Hover_Color(Color_json=Configuration_RadioButton_Normal["hover_color"], Accent_Color=fg_color)
...
def Get_Option_Menu(Frame: CTk|CTkFrame) -> CTkOptionMenu:
    ...
    button_color = Define_Accent_Color(Color_json=Configuration_Base_Option_Menu["button_color"])
    button_hover_color_base = Define_Hover_Color(Color_json=Configuration_Base_Option_Menu["button_hover_color"], Accent_Color=button_color)
    dropdown_hover_color_base = Define_Hover_Color(Color_json=Configuration_Base_Option_Menu["dropdown_hover_color"], Accent_Color=button_color)
...
def Get_Option_Menu_Advance(attach: CTkOptionMenu|CTkComboBox|CTkLabel|CTkButton, values: list, command: any) -> CTkScrollableDropdown:
    # Advance CTkScrollableDropdown
    Configuration_Advance_Option_Menu = Configuration["Fields"]["OptionMenu"]["AdvancedCTk"]["Normal"]

    Accent_Color_help = Define_Accent_Color(Color_json=Configuration_Advance_Option_Menu["fg_color"])
    scrollbar_button_hover_color_advance = Define_Hover_Color(Color_json=Configuration_Advance_Option_Menu["scrollbar_button_hover_color"], Accent_Color=Accent_Color_help)
    hover_color_advance = Define_Hover_Color(Color_json=Configuration_Advance_Option_Menu["hover_color"], Accent_Color=Accent_Color_help)
...
def Get_CheckBox(Frame: CTk|CTkFrame) -> CTkCheckBox:
    ...
    fg_color = Define_Accent_Color(Color_json=Configuration_Check_Box["fg_color"])
    hover_color = Define_Hover_Color(Color_json=Configuration_Check_Box["hover_color"], Accent_Color=fg_color)
...
def Get_Dashboard_Widget_Frame_Body_Scrollable(Frame: CTk|CTkFrame, Widget_Line: str, Widget_size: str) -> CTkScrollableFrame:
    ...
    Accent_Color_help = Define_Accent_Color(Color_json=Configuration_Frame_Dash_Body_Scroll["Accent_Color_help"])
    scrollbar_button_hover_color = Define_Hover_Color(Color_json=Configuration_Frame_Dash_Body_Scroll["scrollbar_button_hover_color"], Accent_Color=Accent_Color_help)
...
def Get_Widget_Scrollable_Frame(Frame: CTk|CTkFrame, Frame_Size: str) -> CTkScrollableFrame:
    ...
    scrollbar_button_hover_color = Define_Hover_Color(Color_json=Configuration_Scrollable["scrollbar_button_hover_color"], Accent_Color=Accent_Color_help)
...
def Get_Tab_View(Frame: CTk|CTkFrame, Tab_size: str) -> CTkTabview:
    ...
    segmented_button_selected_color = Define_Accent_Color(Color_json=Configuration_TabView_Normal["segmented_button_selected_color"])
    segmented_button_selected_hover_color = Define_Hover_Color(Color_json=Configuration_TabView_Normal["segmented_button_selected_hover_color"], Accent_Color=segmented_button_selected_color)
    segmented_button_unselected_hover_color = Define_Hover_Color(Color_json=Configuration_TabView_Normal["segmented_button_unselected_hover_color"], Accent_Color=segmented_button_selected_color)
...
def Get_Table(Frame: CTk|CTkFrame, Table_size: str, rows: int, columns: int) -> CTkTable:
    ...
    header_color = Define_Accent_Color(Color_json=Configuration_Table_Single["header_color"])
    hover_color = Define_Hover_Color(Color_json=Configuration_Table_Single["hover_color"], Accent_Color=header_color)
...
def Get_DialogWindow(text: str, title: str, Dialog_Type: str) -> CTkInputDialog:
    ...
    button_fg_color = Define_Accent_Color(Color_json=Configuration_Dialog["button_fg_color"])
    button_hover_color = Define_Hover_Color(Color_json=Configuration_Dialog["button_hover_color"], Accent_Color=button_fg_color)
